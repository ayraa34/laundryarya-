...
<head>
   ...
   <link href="../assets/bootstrap/dist/css/bootstrap.min.css" rel="stylesheet">
    ...
    <!-- color CSS -->
    <link href="../assets/css/colors/de.css" id="theme" rel="stylesheet">
    <!-- DataTables -->
            ...
            <div class="navbar-header">
                ...
                <ul class="nav navbar-top-links navbar-right pull-right">
                    ...
                    <li>
                        ...
                        ?>
                        <a class="profile-pic" href="#"> <img src="../assets/plugins/images/users/working.png" alt="user-img" width="20" class="img-circle"><b class="hidden-xs">
                            <?= $_SESSION['username'] ?> | <?= $outlet['nama_outlet'] ?>
                        </b></a>
                    </li>
                </ul>
            </div>
